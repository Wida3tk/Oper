...
function BrandMark({ withText = true }: { withText?: boolean }) {
  return (
    <div className={`brand-mark ${withText ? "with-text" : ""}`}>
      <img src="/sulukera-icon.png" alt="شعار سلوكيرا" />
      {withText && (
        <div>
          <b>سلوكيرا</b>
          ...
          >
            ...
            <Section title="آخر النشاطات">
              <div className="timeline">
                <p>
                  تم تحديث حالة التسجيل<small>الآن · {selected.owner}</small>
                </p>
                <p>
                  تم إنشاء التسجيل في النظام<small>أمس، 16:20 · المبيعات</small>
                </p>
              </div>
            </Section>
          </aside>
        ...
        {step === 2 && (
          <>
            ...
            {scheduledJourney ? (
              ...
              <div className="hint">
                {form.journey === "تجربة"
                  ? "تبدأ رحلة التجربة دون دفعة، وفق المدة المحددة للبرنامج."
                  : "يبدأ الاشتراك رحلة العميل المعتادة مباشرة بعد تسجيل الدفع."}
              </div>
            )}
          </>
        )}
